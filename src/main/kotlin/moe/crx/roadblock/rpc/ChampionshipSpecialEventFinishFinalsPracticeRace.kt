...
@Serializable
data class ChampionshipSpecialEventFinishFinalsPracticeRaceRequest(
...
@Serializable
data class ChampionshipSpecialEventFinishFinalsPracticeRaceResponse(
    @ByteEnum
...
suspend fun handleChampionshipSpecialEventFinishFinalsPracticeRace(
    ...
    session.sendResponse(ChampionshipSpecialEventFinishFinalsPracticeRaceResponse())
}