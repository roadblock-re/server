...
@Serializable
data class ActivationBlackMarketBuyRequest(
...
@Serializable
class ActivationBlackMarketBuyResponse : UpdatesQueueWithRootReactionsResponse()

suspend fun handleActivationBlackMarketBuy(
    session: GameConnection,
    request: ActivationBlackMarketBuyRequest
) {
    session.sendResponse(ActivationBlackMarketBuyResponse())
}