...
@Serializable
data class ChampionshipSpecialEventFinishQualifyingRaceRequest(
...
@Serializable
data class ChampionshipSpecialEventFinishQualifyingRaceResponse(
    @ByteEnum
...
suspend fun handleChampionshipSpecialEventFinishQualifyingRace(
    ...
    session.sendResponse(ChampionshipSpecialEventFinishQualifyingRaceResponse())
}