...
@Serializable
data class ChampionshipSpecialEventFinishQualifyingPracticeRaceRequest(
...
@Serializable
data class ChampionshipSpecialEventFinishQualifyingPracticeRaceResponse(
...
suspend fun handleChampionshipSpecialEventFinishQualifyingPracticeRace(
    ...
    session.sendResponse(ChampionshipSpecialEventFinishQualifyingPracticeRaceResponse())
}