...
class ChampionshipSpecialEventFinishQualifyingRaceRequest : RequestPacket() {
    ...
    override fun read(sink: InputSink) {
        ...
        pushNotificationVersion = sink.readString()
    ...
    override fun write(sink: OutputSink) {
        ...
        sink.writeString(pushNotificationVersion)
