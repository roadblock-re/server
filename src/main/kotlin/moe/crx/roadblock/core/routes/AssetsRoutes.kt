...
import moe.crx.roadblock.core.utils.sha256
import java.io.File
...
fun Route.assetsGetAssetMetadata(workingDirectory: String, config: Configuration) =
    get("/assets/{clientId}/{assetId}/metadata") {
        val clientId = call.parameters["clientId"]
        val assetId = call.parameters["assetId"]
